            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        ...
                        <p v-else>
                            A autenticação de dois fatores agora está habilitada. Escaneie o seguinte código QR usando o aplicativo autenticador do seu telefone ou insira a chave de configuração.
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            Armazene esses códigos de recuperação em um gerenciador de senhas seguras. Eles podem ser usados para recuperar ou acessar sua conta se seu dispositivo de autenticação de dois fatores for perdido.
                        </p>
                    </div>
